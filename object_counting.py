...
# model = YOLO("best.pt")
# cap = cv2.VideoCapture("/mnt/sdb/personal/yolo_tracking/recording-6.mp4")
# assert cap.isOpened(), "Error reading video file"
# w, h, fps = (int(cap.get(x)) for x in (cv2.CAP_PROP_FRAME_WIDTH, cv2.CAP_PROP_FRAME_HEIGHT, cv2.CAP_PROP_FPS))

# line_points = [(0, 0),(0, 2480), (2480, 0), (2480, 2480)]#[(20, 400), (1080, 400)]  # line or region points
# classes_to_count = [14]  # person and car classes for count
...
counting_regions = [
    ...
    },
    {
        ...
        "polygon": Polygon([(750, 1040), (750, 1740), (1490, 1740), (1490, 1040)]),  # Polygon points
        "counts": 0,
        "dragging": False,
...
def parse_opt():
    ...
    parser.add_argument("--weights", type=str, default="/root/ws/med_si_track/custom_needle/train7/weights/best.pt", help="initial weights path")
    parser.add_argument("--device", default="0", help="cuda device, i.e. 0 or 0,1,2,3 or cpu")
    parser.add_argument("--source", type=str,default="/root/ws/med_si_track/test_data/training_6.avi", required=False, help="video file path")
